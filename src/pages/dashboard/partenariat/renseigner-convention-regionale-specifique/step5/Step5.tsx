...
import { LIST_CONTRIBUTION_PARTENAIRE } from "../../../../../constants/DataConstants";
...
function Step5() {
    ...
    const list_contribution_partenaire_store = useAppSelector((state) => state.renseignerConvRegionaleSpecifiqueReducer.listContributionPartenaire);
    ...
    return (
        <div className='container-step5-conv-regionale-specifique'
